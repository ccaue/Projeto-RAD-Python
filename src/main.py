...
entrada_nome = tk.Entry(frame_form, width=25)
...
entrada_av1 = tk.Entry(frame_form, width=25)
entrada_av1.grid(row=1, column=1, padx=5, pady=5)

tk.Label(frame_form, text="Nota AV2:", bg="#f0f0f0").grid(row=2, column=0, padx=5, pady=5)
entrada_av2 = tk.Entry(frame_form, width=25)
entrada_av2.grid(row=2, column=1, padx=5, pady=5)

# Botões para cadastrar e excluir aluno.
bt_cadastrar = tk.Button(frame_form, text="Cadastrar", command=cadastro_aluno, bg="#4CAF50", fg="white")
bt_cadastrar.grid(row=3, column=1, padx=5, pady=5)

bt_excluir = tk.Button(frame_form, text="Excluir", command=excluir_aluno, bg="#f44336", fg="white")
bt_excluir.grid(row=4, column=1, padx=5, pady=5)
...
treeview.pack()  # Exibe os dados salvos na database.
